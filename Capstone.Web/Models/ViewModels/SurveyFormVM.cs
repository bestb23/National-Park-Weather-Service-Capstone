...
namespace Capstone.Web.Models.ViewModels
{
        ...
        public List<SelectListItem> States = new List<SelectListItem>()
    {
        ...
        public List<SelectListItem> ActivityLevel = new List<SelectListItem>()
        {
            new SelectListItem("Inactive", "Inactive"),
            new SelectListItem("Sedentary", "Sedentary"),
            new SelectListItem("Active", "Active"),
            new SelectListItem("Extremely Active", "Extremely Active")
        };
    }
}
